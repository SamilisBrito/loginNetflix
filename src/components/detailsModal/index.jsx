...
export function DetailsModal() {
  ...
  if (isOpen)
    return (
      <section className="fixed top-0 left-0 z-30 flex items-center justify-center w-full h-full bg-black/20 overflow-auto pt-5 px-5">
        <div className="relative z-30 rounded text-white bg-neutral-900  xl:w-[56rem] overflow-hidden m-auto">
          ...
          <div className="relative max-w-full">
            <Movie movie={movieDetails} width={"w-full"}/>

            <div className="absolute top-1/2 md:top-3/4 left-5 z-20 text-neutral-900">
              <p className="text-xl sm:text-3xl text-white font-semibold mb-4">
                {movieDetails?.title}
              </p>
